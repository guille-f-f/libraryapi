...
public interface BookRepository extends JpaRepository<Book, Long> {
        ...
        @Query("SELECT new com.egg.libraryapi.models.BookResponseDTO(b.isbn, b.bookActive, b.bookTitle, b.specimens, b.imageUrl, new com.egg.libraryapi.models.EditorialResponseDTO(b.editorial.editorialName), new com.egg.libraryapi.models.AuthorResponseDTO(b.author.authorName)) FROM Book b WHERE b.isbn = :isbn")
        BookResponseDTO findBookResponseDTOByISBN(@Param("isbn") Long isbn);

        // Only the active books are required
        @Query("SELECT new com.egg.libraryapi.models.BookResponseDTO(b.isbn, b.bookActive, b.bookTitle, b.specimens, b.imageUrl, new com.egg.libraryapi.models.EditorialResponseDTO(b.editorial.editorialName), new com.egg.libraryapi.models.AuthorResponseDTO(b.author.authorName)) FROM Book b WHERE b.bookActive = true")
        ...
        // Filter by author
        @Query("SELECT new com.egg.libraryapi.models.BookResponseDTO(b.isbn, b.bookActive, b.bookTitle, b.specimens, b.imageUrl, new com.egg.libraryapi.models.EditorialResponseDTO(b.editorial.editorialName), new com.egg.libraryapi.models.AuthorResponseDTO(b.author.authorName)) FROM Book b WHERE b.author.idAuthor = :idAuthor")
